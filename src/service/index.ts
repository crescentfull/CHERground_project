...
export interface ProductService {
    ...
    saveProduct(product: object, clearance: boolean): Promise<string | undefined>;
...
export interface CategoryService {
    ...
    saveCategory(category: object, clearance: boolean): Promise<object | string | undefined>;
...
export interface ProductCategoryService {
    ...
    deleteProductCategory(id: ProductCategoryDto, clearance: boolean): Promise<string>; 
}
